      ...
      {top10CatalogItems.length > 0 && (
        <section className="py-12 sm:py-20 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex flex-nowrap items-center gap-4 sm:gap-6 pb-4" style={{ width: "max-content" }}>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} custom={1}>
            <Accordion type="single" collapsible className="space-y-3">
              {[
                ...
                { q: "Is Queer Scenes safe to subscribe to?", a: "Yes. All payments are processed securely by Stripe — one of the world's most trusted payment platforms. We never store your card details. You can manage your subscription from your profile." },
                ...
                { q: "How do I cancel?", a: (<>Sign in and open <strong className="text-foreground">Profile</strong>, then select <strong className="text-foreground">Manage subscription</strong>. Review the benefits you will lose and choose to continue to Stripe. In Stripe's secure portal, enter the same email used for your subscription, open your active plan, and select cancel. For questions about billing or access, use our <button type="button" onClick={() => setSupportOpen(true)} className="text-[var(--brand-pink)] underline hover:opacity-80 font-semibold">Support</button> form.</>) },
