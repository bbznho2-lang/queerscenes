          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} custom={1}>
            <Accordion type="single" collapsible className="space-y-3">
              {[
                ...
                { q: "Is Queer Scenes safe to subscribe to?", a: "Yes. All payments are processed securely by Stripe — one of the world's most trusted payment platforms. We never store your card details. You can cancel anytime from your profile with one click." },
